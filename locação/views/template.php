        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <h1>Sistema de Locadora de Livros</h1>
        ...
        <div class="row same-height-row">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    <div class="card-header" style="background-color: #001d67; color: white">
                        <h4 class="mb-0">Adicionar Novo Livro</h4>
                    </div>
                    <div class="card-body" style="color:  #001d67 ">
                        <form method="post" class="needs-validation" novalidate>
                            <div class="mb-3">
                                <label class="form-label">Título</label>
                                <input type="text" name="titulo" class="form-control" required>
                                <div class="invalid-feedback">Informe um Título válido.</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Autor</label>
                                <input type="text" name="autor" class="form-control" required>
                                <div class="invalid-feedback">Informe um Autor válida.</div>
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" name="adicionar" class="btn btn-primary w-100" style="background: #001d67;">Adicionar Livro</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="col-<?= Auth::isAdmin() ? 'md-6' : '12' ?>">
                <div class="card h-100">
                    <div class="card-header" style="background: #001d67; color:white">
                        <h4 class="mb-0"style>Calcular Previsão de Aluguel</h4>
                    </div>
                    <div class="card-body">
                        <form method="post" class="needs-validation" novalidate>
                            <div class="mb-3">
                            ...
                            <button type="submit" name="calcular" class="btn btn-info w-100" style ="background: #001d67; color:#fff">Calcular Previsão</button>
                        </form>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($locadora->listarLivro() as $livro): ?>
                                    <tr>
                                        <td><?= $livro instanceof \Models\Digital ? 'digital' : 'fisico' ?></td>
                                        <td><?= htmlspecialchars($livro->getTitulo()) ?></td>
                                        <td><?= htmlspecialchars($livro->getAutor()) ?></td>
                                        <td>
                                            <span class="badge bg-<?= $livro->isDisponivel() ? 'success' : 'warning' ?>">
                                        ...
                                        <td>
                                            <div class="action-wrapper">
                                                <form method="post" class="btn-group-actions">
                                                    ...
                                                    <input type="hidden" name="autor" value="<?= htmlspecialchars($livro->getAutor()) ?>">
